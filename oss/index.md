...
OSSにコントリビュートするハードルが高いと思う方は、OSSにチャレンジという発想やめて必要なときにすればいいと思います。例えば、ライブラリのドキュメントにタイポ見つけたのでプルリクエスト投げるとか。
一回のコントリビュートが自信につながります。

[Good First Issue](https://goodfirstissue.dev/)というGithubの`good first issue`ラベルが付いたIssueの一覧を参照できるサイトがあります。<br>
※`good first issue`ははじめてのコントリビュートに向いているIssueにつけられるラベル
ぜひコントリビューションしてみてください！
